  ...
  return (
    <html lang="en" className={darkMode ? 'dark' : ''}>
      <head>
        ...
        <meta name="description" content="Live Trading Dashboard" />
      </head>
      <body className={`${inter.className} min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/30 dark:to-blue-900/20`}>
        <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/80 dark:bg-gray-900/80 border-b border-white/20 dark:border-gray-800">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-8">
              ...
              <button
                onClick={toggle}
                className="p-3 rounded-full bg-gray-200/50 dark:bg-gray-800/50 backdrop-blur hover:scale-110 transition"
              >
