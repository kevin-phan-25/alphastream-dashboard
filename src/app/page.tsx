...
export default function TradingBotDashboard() {
  ...
  const fetchActivityLogs = async () => {
    try {
      ...
      setLogs(raw.map(cleanLog).filter(Boolean).slice(-500));
    } catch {}
  };
  ...
  useEffect(() => {
    ...
    const i1 = setInterval(fetchCore, 20000);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Logs (Completely Static - No Scroll Issues) */}
        <div className="glass rounded-3xl p-6">
          ...
          <div className="bg-black/60 rounded-2xl p-5 overflow-auto text-sm font-mono h-[420px] overflow-y-auto">
