    ...
    <div className="min-h-screen bg-zinc-950 text-white p-6 bg-grid-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          <button onClick={triggerScan} disabled={actionLoading === '/admin/scan'} className="bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-700 px-7 py-3.5 rounded-2xl font-medium flex items-center gap-3 transition hover-scale">
            <Rocket /> MANUAL SCAN
          </button>
          <button onClick={panicFlat} disabled={actionLoading === '/admin/hard-flat'} className="bg-red-600 hover:bg-red-500 disabled:bg-zinc-700 px-7 py-3.5 rounded-2xl font-medium flex items-center gap-3 transition hover-scale">
            <Shield /> PANIC FLAT
          </button>
          ...
          <button onClick={triggerTraining} disabled={actionLoading === 'train'} className="bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 px-7 py-3.5 rounded-2xl font-medium flex items-center gap-3 transition hover-scale">
