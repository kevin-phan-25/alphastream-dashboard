...
export default function Home() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-2">AlphaStream Dashboard</h1>
      <p className="mb-4">Equity: ${equity.toFixed(2)}</p>
      {loading && <Loader2 className="animate-spin"/>}

      <h2 className="text-xl font-semibold mt-4">Positions</h2>
      ...
      <h2 className="text-xl font-semibold mt-4">Rockets</h2>
      <table className="table-auto border-collapse border border-gray-400 w-full">
        <thead>
          <tr>
            <th className="border px-2 py-1">Symbol</th>
