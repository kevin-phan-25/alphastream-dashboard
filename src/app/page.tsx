// src/app/page.tsx — v81.1 FINAL DASHBOARD (Deploy This Now)
'use client';
import { useState, useEffect } from 'react';
import axios from 'axios';
import {
  RefreshCw, X, DollarSign, Target, Swords, Zap, AlertTriangle, TrendingUp, Activity
} from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-900 to-black flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-400 mt-4">Check BOT_URL not set in Vercel</p>
        </div>
      </div>
    );
  }
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="text-center">
              ...
              >
                ...
                {scanning ? "SCANNING..." : "FORCE NUCLEAR SCAN"}
              </button>
            </div>
