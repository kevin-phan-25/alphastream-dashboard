...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      {/* Lighter subtle gradient BG */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900/5 via-black/5 to-cyan-900/5" />

      {/* Header */}
      <header className="fixed top-0 inset-x-0 bg-gray-900/80 px-4 py-3 z-50 border-b border-purple-600/20">
      ...
      <main className="pt-20 px-4 max-w-2xl mx-auto space-y-6 pb-20">
        ...
        {/* Equity */}
        <div className="bg-gray-800/60 rounded-2xl p-6 text-center border border-purple-600/20">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-gray-800/60 rounded-xl p-4 text-center border border-purple-600/20">
          ...
          <div className="bg-gray-800/60 rounded-xl p-4 text-center border border-cyan-600/20">
          ...
          <div className="bg-gray-800/60 rounded-xl p-4 text-center border border-green-600/20">
          ...
          <div className="bg-gray-800/60 rounded-xl p-4 text-center border border-yellow-600/20">
        ...
        {/* Positions */}
        {positions.length > 0 ? (
          <div className="bg-gray-800/60 rounded-2xl p-4 border border-green-600/20">
            <div className="text-green-400 font-bold mb-3 text-center">POSITIONS</div>
            <div className="space-y-2">
              {positions.slice(0, 8).map((p: any, i: number) => (
                <div key={i} className="flex justify-between py-2 px-3 bg-gray-900/30 rounded-lg">
          ...
          <div className="bg-gray-800/40 rounded-2xl p-8 text-center text-gray-400 border border-dashed border-gray-600">
            No open positions
          </div>
        )}

        {/* Brain Status */}
        <div className="bg-gray-800/60 rounded-2xl p-5 border border-purple-600/20">
        ...
        {/* Logs */}
        <div className="bg-gray-800/50 rounded-2xl p-4 border border-green-700/20">
        ...
        <div className="text-center">
          <button
            ...
            className="px-12 py-4 text-lg font-bold rounded-full bg-gradient-to-r from-purple-500/70 to-cyan-500/70 hover:from-purple-400 hover:to-cyan-400 transition-all duration-500 disabled:opacity-50 border border-purple-700/40 shadow-md"
          >
