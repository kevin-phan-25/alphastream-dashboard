    ...
    <div className="min-h-screen bg-black text-white font-mono text-sm">
      <header className="fixed top-0 inset-x-0 bg-black/95 border-b border-purple-800 px-4 py-2 flex justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-cyan-400">{data.activeAccount || "Unknown"}</span>
        </div>
      </header>
      ...
      <main className="pt-14 px-4 max-w-xl mx-auto space-y-4 pb-24">
        ...
        <div className="grid grid-cols-4 gap-3 text-center">
          <div className="bg-gray-900/80 rounded-lg p-3 border border-purple-700"><div className="text-xl font-bold text-purple-400">{data.positions || 0}/3</div><div className="text-xs text-gray-500">Pos</div></div></div>
          <div className="bg-gray-900/80 rounded-lg p-3 border border-cyan-700"><div className="text-xl font-bold text-cyan-400">{data.rockets?.length || 0}</div><div className="text-xs text-gray-500">Rockets</div></div>
          <div className="bg-gray-900/80 rounded-lg p-3 border border-yellow-700"><div className="text-xl font-bold text-yellow-400">{data.winRate || "0.0"}%</div><div className="text-xs text-gray-500">Win</div></div>
          <div className="bg-gray-900/80 rounded-lg p-3 border border-green-700"><div className="text-xl font-bold text-green-400">1:2.8</div><div className="text-xs text-gray-500">RR</div></div>
        </div>

        <div className="bg-black/90 rounded-xl p-4 border border-green-700">
          <h3 className="text-green-400 font-bold text-xs mb-2">LOGS</h3>
